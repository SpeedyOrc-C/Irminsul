...
<SubCategory>{$_("settings.other.reset")}</SubCategory>

<ItemBar text={$_("settings.other.reset-all")}>
    <ButtonInSettings on:button-clicked={() => dispatch("reset-all")}>
        {$_("settings.msg.click-to-reset")}
    </ButtonInSettings>
</ItemBar>
